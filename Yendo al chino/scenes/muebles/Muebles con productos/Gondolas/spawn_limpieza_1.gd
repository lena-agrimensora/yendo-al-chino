...
@export var scene_paths: Array[String] = [
	"res://ESCENAS/Productos_Lena_Test/Herramientas/Productos TSCN/Jabon blanco_jabonBlanco_TEX.tscn",
	"res://ESCENAS/Productos_Lena_Test/Herramientas/Productos TSCN/Jabon polvo_jabonPolvo_quitamanchas_TEX.tscn"
]
