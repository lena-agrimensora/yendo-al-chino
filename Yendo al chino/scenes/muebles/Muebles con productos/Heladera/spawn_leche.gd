...
@export var scene_paths: Array[String] = [
	"res://productos/lacteos_congelados/lacteos/leche_descremada_santor.tscn",
	"res://productos/lacteos_congelados/lacteos/leche_entera_santor.tscn",
	"res://productos/lacteos_congelados/lacteos/leche_falsa_santor.tscn"
]
