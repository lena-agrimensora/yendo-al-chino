...
@onready var label = $Sprite3D2/SubViewport/TextBox/MarginContainer/Label
@onready var area = $Sprite3D2/Area3D
@onready var timer = $Sprite3D2/SubViewport/TextBox/LetterDisplayTimer
@onready var sonido_texto = $Sprite3D2/AudioStreamPlayer3D

var ya_mostrado = false
var lineas_de_dialogo = [
	"Las peras estan medio raras hoy.",
]
